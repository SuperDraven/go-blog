...
func ServiceGenerateCaptchaHandler() (captchas CaptchaResponse) {
	length := captcha.DefaultLen
	captchaId := captcha.NewLen(length)
	var captcha CaptchaResponse
	captcha.CaptchaId = captchaId
	captcha.ImageUrl = conf.LoadConf().SiteUrl + ":" + conf.LoadConf().SitePort + "/api/getCaptcha/Getcaptcha/"+ captchaId + ".png"
